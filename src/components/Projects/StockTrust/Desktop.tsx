...
const Desktop: React.FC<DesktopProps> = ({ tags }) => {
  return (
    <>
      <div className="project stocktrust">
        ...
        <div className="project__content-wrapper-desktop">
          ...
          <div className="project__content project__content-desktop">
            ...
            <p>
              ...
              concurrently across multiple threads, queues the results, and
            ...
            <p>
              ...
              renderer, a scraper, and a data communication service serving as
              an entrypoint for the renderer to get data.
            </p>
            <p>
              For deployment, I created Dockerfiles for all services and
              combined them into a Docker Compose setup, which also runs
              PostgreSQL and an Nginx server responsible for routing requests.
            </p>
            <p>
