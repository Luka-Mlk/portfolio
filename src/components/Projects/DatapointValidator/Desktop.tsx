      ...
      <div className="project datapointvalidator">
        ...
        <div className="project__content-wrapper-desktop">
          ...
          <div className="project__content project__content-desktop">
            <p>
              While working at a print shop, I’d had enough of the tedious
              manual labor that was tracking down client design files across our
              storage system. It was slow, repetitive, and prone to human error
